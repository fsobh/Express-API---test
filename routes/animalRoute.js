...
router.post('/',(req, response) => {
    ...
    if(_.isEmpty(req.body)){ //if no data was provided in the body, 
        response.send("No data provided in the body")
        response.end()
    }

    dbQuery.query("UPDATE animals SET animal_name = $1, animal_type = $2 , animal_age = $3  WHERE ID = $4", [req.body.name,req.body.type,req.body.age,animal_id]).then((res) => {
